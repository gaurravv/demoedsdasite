...
var CustomImportScript = (() => {
  ...
  // tools/importer/import-resources-hub.js
  var import_resources_hub_exports = {};
  __export(import_resources_hub_exports, {
    default: () => import_resources_hub_default
  });
  ...
  var PAGE_TEMPLATE = {
    name: "resources-hub",
    description: "Content hub/listing page: hero intro, grid of category teaser cards linking to article sub-hubs, and a policy-books link list.",
    urls: ["https://www.admiral.com/resources/home-hub"],
    blocks: [
      {
        "name": "hero-promo",
        "instances": [
  ...
  var import_resources_hub_default = {
    transform: (payload) => {
  ...
  return __toCommonJS(import_resources_hub_exports);
})();
